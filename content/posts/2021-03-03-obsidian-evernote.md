...
![](/media/obsidian-github-desktop.png)
...
![](/media/obsidian-github-login.png)
...
![](/media/obsidian-github-website.png)

### 4. 安裝 Obsidian Git

![](/media/obsidian-preference-plugin.png)

打開 Obsidian 左下方的 Preference，Community Plugins 關掉 Safe Mode 就可以安裝 Plug-in。於 Browse 中搜尋 Obsidian Git，就可以直接 Install Obsidian Git Plugin。這個 Plugin 基本上就是定時將你的 Vault Folder，備份到 Github 上。

![](/media/obsidian-git-config.png)

安裝及啟用後，左方將出現 Obsidian Git 的設定，我將 Vault 備份時間改為 5 分鐘，同時也修改每次打開軟件也從 Github Pull 所有的變更，Commit Message 增加 Device 的名稱以玆識別，以及最重要的關掉 Disable Push，才會自動提所有 Commit 推送到 Github 上，讓其他裝置可以同步。

![](/media/obsidian-plugin.png)

同時，我亦於 Hotkey 增加 Obsidian Git 的快捷鍵， <kbd>Cmdl</kbd> + <kbd>Shift</kbd> + <kbd>+</kbd>直接 Commit，<kbd>Cmdl</kbd> + <kbd>Shift</kbd> + <kbd>+</kbd>從 Remote Pull 所有變更。

我嘗試增加新的一頁筆記，等候一會就會直接 Commit，在 Github 上查看，就會見到新檔案更新的日期。同步就大功告成了！

![](/media/obsidian-github-updated.png)
...
- 如只需閱讀，Github 官方應用已可以直接瀏覽所有 Repo
...
![Stash Changes 可將有同步問題的更改存起，同步後再回復](/media/obsidian-github-stash.png)

## 結語：

現時我使用 Obsidian 還是初階的進度，很多功能還未有好好的善用。Plug-in 也引入了很多 Productivity 的貼心功能，如 [Day Planner](https://github.com/lynchjames/obsidian-day-planner)，可以結合時間日程成為個人的 Task Manager 和筆記本。
